...
KEYWORDS="-* ~x86 ~amd64"
MAGIC="408-74b62af"
SRC_URI="x86? ( http://plexapp.com/repo/pool/main/p/plexmediaserver/plexmediaserver_${PV}.${MAGIC}_i386.deb )
	amd64?  ( http://plexapp.com/repo/pool/main/p/plexmediaserver/plexmediaserver_${PV}.${MAGIC}_amd64.deb )"
# this does not seem to work atm(/anymore?)
# SRC_URI="x86?	( http://plex.r.worldssl.net/PlexMediaServer/${PV}.${MAGIC}/plexmediaserver_${PV}.${MAGIC}_i386.deb )
# 	amd64?	( http://plex.r.worldssl.net/PlexMediaServer/${PV}.${MAGIC}/plexmediaserver_${PV}.${MAGIC}_amd64.deb )"
SLOT="0"
LICENSE="PMS-License"
IUSE=""
RESTRICT="mirror"

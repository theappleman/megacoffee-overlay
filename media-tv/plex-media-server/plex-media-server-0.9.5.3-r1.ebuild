...
KEYWORDS="-* ~x86 ~amd64"
SRC_URI="x86?	( http://www.plexapp.com/repo/pool/main/p/plexmediaserver/plexmediaserver_0.9.5.3.275-dff0bd5_i386.deb )
	amd64?	( http://www.plexapp.com/repo/pool/main/p/plexmediaserver/plexmediaserver_0.9.5.3.275-dff0bd5_amd64.deb )"
SLOT="0"
LICENSE="PMS-License"
IUSE=""
...
pkg_preinst() {
	...
	# that is a debian file that does not exist in gentoo and therefore can't be handled through diff
        ...
        epatch "${FILESDIR}"/${PN}-0.9.5.3-startup_fix.patch
